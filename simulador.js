var calcularISV = function () {
    ...
    calcularAgravamentoDeParticulas = function () {
        ...
        if (escolhaParticulas === "mais") {
            mostraAgravamentoParticulas.innerText = 500;
        } else {
...
/*
    ...
    document.addEventListener("DOMContentLoaded", function () {
        var novoUsado = function () {
            var escolhaEstado = document.getElementById("escolhaEstado").value;
            var escolhaIdade = document.getElementById("escolhaIdade");

            if (escolhaEstado === "usado") {
                escolhaIdade.style.display = "block";
            } else {
                escolhaIdade.style.display = "none";
            }
        };

        document.getElementById("escolhaEstado").addEventListener("change", novoUsado);
        novoUsado();
    });
